/*
1. 1. Write query to select film_id, title, length of title, description 
(to be displayed in upper case) from table film (schema - sakila).
*/
...
/*
2. Write query to display result set shown in figure 1 
...
/*
3.  Write query to display result set shown in figure 2 
from table film (schema - sakila).
*/
...
/*
4. Write query to display result set shown in figure 3 
from table film (schema - sakila).
*/
...
/*
5. Write query to display number of days since the last update 
in table actor (schema - sakila).
*/
...
/*
6.  Write query to display result set shown in figure 4 
